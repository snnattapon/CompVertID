...
**Windows:** ดับเบิลคลิกไฟล์ `.exe` (ครั้งแรกถ้ามีหน้าต่าง "Windows protected your PC" ให้กด **More info → Run anyway**)

**Mac:** ดับเบิลคลิกไฟล์ `.zip` เพื่อแตกไฟล์ จะได้ `CompVertID.app` → **ครั้งแรกให้คลิกขวาที่ `CompVertID.app` แล้วเลือก Open** (ไม่ใช่ดับเบิลคลิก) → กด **Open** ในกล่องที่เด้งขึ้นมา หลังจากนั้นเปิดด้วยการดับเบิลคลิกได้ตามปกติ
